...
abstract class SolrConnectorPluginBase extends ConfigurablePluginBase implements SolrConnectorInterface, PluginFormInterface {
	...
	public function buildConfigurationForm(array $form, FormStateInterface $form_state) {
		$form['scheme'] = [
			...
			'#default_value' => isset($this->configuration['scheme']) ? $this->configuration['scheme'] : 'https',
			'#options' => [
				'http' => 'http',
				'https' => 'https',
			],
	...
	public function getServerInfo($reset = FALSE) {
		$this->useTimeout();
		return $this->getDataFromHandler('solrAdmin/default/admin/info/system', $reset);
	}
	...
	public function getCoreInfo($reset = FALSE) {
		$this->useTimeout();
		return $this->getDataFromHandler('solrAdmin/default/'.$this->configuration['core'] . '/admin/system', $reset);
	}
