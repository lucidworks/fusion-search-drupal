...
use Drupal\search_api_fusion\Plugin\search_api\processor\Property\DummyFieldProperty;
 ...
 *   description = @Translation("Adds dummy fields to all datasources to register a pseudo field names that get their values via API, for example hook_search_api_fusion_documents_alter()."),
 *   stages = {
 *     "add_properties" = 0,
 *   },
 *   locked = false,
  ...
  public function getPropertyDefinitions(DatasourceInterface $datasource = NULL) {
    ...
    if ($datasource) {
      $definition = [
        ...
        'description' => $this->t('Adds dummy field that gets its values via API, for example hook_search_api_fusion_documents_alter().'),
        'type' => 'string',
