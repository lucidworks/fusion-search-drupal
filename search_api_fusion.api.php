 ...
 * hook_search_api_fusion_converted_query() instead. If you want to force a
 ...
 */
function hook_search_api_fusion_query_alter(\Solarium\Core\Query\QueryInterface $solarium_query, \Drupal\search_api\Query\QueryInterface $query) {
  ...
  if ($query->getOption('my_custom_boost')) {
    ...
    // @see https://www.drupal.org/project/search_api_fusion/issues/2855329
 ...
 *   The Search API query object representing the executed search query.
 */
function hook_search_api_fusion_terms_autocomplete_query_alter(\Drupal\search_api\Query\QueryInterface $query) {
 ...
 *   The Search API query object representing the executed search query.
 */
function hook_search_api_fusion_spellcheck_autocomplete_query_alter(\Drupal\search_api_fusion\Solarium\Autocomplete\Query $solarium_query, \Drupal\search_api\Query\QueryInterface $query) {
 ...
 *   The Search API query object representing the executed search query.
 */
function hook_search_api_fusion_suggester_autocomplete_query_alter(\Drupal\search_api_fusion\Solarium\Autocomplete\Query $solarium_query, \Drupal\search_api\Query\QueryInterface $query) {
 ...
 * hook_search_api_fusion_query_alter().
 *
 * @param \Solarium\Core\Query\QueryInterface $solarium_query
 *   The Solarium query object, as generated from the Search API query.
 * @param \Drupal\search_api\Query\QueryInterface $query
 *   The Search API query object representing the executed search query.
 */
function hook_search_api_fusion_converted_query_alter(\Solarium\Core\Query\QueryInterface $solarium_query, \Drupal\search_api\Query\QueryInterface $query) {
 ...
 */
function hook_search_api_fusion_field_mapping_alter(\Drupal\search_api\IndexInterface $index, array &$fields, string $language_id) {
 ...
 */
function hook_search_api_fusion_documents_alter(array &$documents, \Drupal\search_api\IndexInterface $index, array $items) {
 ...
 */
function hook_search_api_fusion_search_results_alter(\Drupal\search_api\Query\ResultSetInterface $result_set, \Drupal\search_api\Query\QueryInterface $query, \Solarium\QueryType\Select\Result\Result $result) {
 ...
 */
function search_api_fusion_hook_search_api_data_type_info() {
  return [
 ...
 *   The search index.
 */
function hook_search_api_fusion_finalize_index(\Drupal\search_api\IndexInterface $index) {
 ...
 */
function hook_search_api_fusion_config_files_alter(array &$files, string $lucene_match_version, string $server_id = '') {
